// @ts-nocheck
import lunar = require("../src/lunar");

const { Solar, Lunar, LunarYear } = lunar;
...
test('test9', () => {
  ...
  expect(lunar.getSolar().toString()).toBe('1500-02-09');
});

test('test10', () => {
  const lunar = Lunar.fromYmdHms(1500,12,29,12,0,0);
  expect(lunar.getSolar().toString()).toBe('1501-01-28');
});

test('test11', () => {
  const solar = Solar.fromYmdHms(1500,1,1,12,0,0);
  expect(solar.getLunar().toString()).toBe('一四九九年冬月廿一');
});

test('test12', () => {
  const solar = Solar.fromYmdHms(1500,12,31,12,0,0);
  expect(solar.getLunar().toString()).toBe('一五〇〇年腊月初一');
});

test('test13', () => {
  const solar = Solar.fromYmdHms(1582,10,4,12,0,0);
  expect(solar.getLunar().toString()).toBe('一五八二年九月初八');
});
...
test('test15', () => {
  ...
  expect(lunar.getSolar().toString()).toBe('1582-10-14');
});
...
test('test17b', () => {
  const lunar = Lunar.fromYmdHms(1022,1,30,12,0,0);
  expect(lunar.getSolar().toString()).toBe('1022-03-11');
});
...
test('test40', () => {
  ...
  expect(solar.getLunar().toString()).toBe('〇年冬月二十');
});
...
test('test42', () => {
  ...
  expect(lunar.getSolar().toString()).toBe('0000-12-30');
});
...
test('test054', () => {
  ...
  expect(lunar.getOtherFestivals() + '').toBe('');
});
...
test('test059', () => {
  ...
  expect(lunar.getSolar().toString()).toBe('1518-02-20');
});

test('test060', () => {
  const lunar = Lunar.fromYmd(793, 1, 1);
  expect(lunar.getSolar().toString()).toBe('0793-02-19');
});
...
test('test063', () => {
  ...
  expect(lunar.getSolar().toString()).toBe('0193-02-18');
});
...
test('test065', () => {
  ...
  expect(lunar.getSolar().toString()).toBe('0755-02-20');
});

test('test066', () => {
  const lunar = Lunar.fromYmd(41, 1, 1);
  expect(lunar.getSolar().toString()).toBe('0041-02-18');
});

test('test067', () => {
  const lunar = Lunar.fromYmd(57, 1, 1);
  expect(lunar.getSolar().toString()).toBe('0057-02-21');
});

test('test068', () => {
  const lunar = Lunar.fromYmd(345, 1, 1);
  expect(lunar.getSolar().toString()).toBe('0345-02-19');
});

test('test069', () => {
  const solar = Solar.fromYmd(917, 12, 1);
  expect(solar.getLunar().toString()).toBe('九一七年闰十月初九');
});

test('test070', () => {
  const solar = Solar.fromYmd(917, 12, 31);
  expect(solar.getLunar().toString()).toBe('九一七年冬月初十');
});

test('test071', () => {
  const solar = Solar.fromYmd(918, 1, 1);
  expect(solar.getLunar().toString()).toBe('九一七年冬月十一');
});
